class H2HResponseModel{
  ...
  H2HResponseModel(this.fixture,this.score,this.teams,this.goals,this.league,);

  H2HResponseModel.fromJson(Map<String,dynamic>json ){
...
class FixtureModel{
    ...
    FixtureModel(this.id,this.date,this.status,this.referee,this.timezone);
...
String? long;
String? short;
dynamic elapsed; // it is finished time
